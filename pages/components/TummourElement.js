				...
				<div className="detail-info">
					<div className="description">
		 			...
		 			<div className="btn-menu">
		 				<a href="/static/files/MENU_TUMMOUR.pdf" target="_blank">ดูเมนู</a>
		 			</div>
		 				...
		 				<Tabs>
						    ...
						    <TabPanel>
						      	<ul>
						      		...
						      		<li>
						      			<h4>อิมพีเรียลเวิลด์ สำโรง</h4>
						      			<p>โทร. 02-183-0718</p>
						      		</li>
						      		<li>
						      			<h4>ปทุมธานี</h4>
						      			<p>โทร. 085-6834677,0-2581-3745</p>
						      		</li>
						      		<li>
						      		...
						      		<li>
						      			<h4>บิ๊กซี ราชดำริ</h4>
						      			<p>โทร. 02-250-5438</p>
						      		</li>
						      		<li>
						      			<h4>ร้านตำมั่ว Express - ปตท.บางพูน</h4>
						      			<p>โทร. 02-567-2989</p>
						      		</li>
						      		<li>
						      			<h4>ปตท.เกษตร-นวมินทร์</h4>
						      			<p>โทร. 02-508-0705</p>
						      		</li>
						      		<li>
						      			<h4>บิ๊กซี ปทุมธานี</h4>
						      			<p>โทร. 02-518-2000</p>
						      		</li>
						      		<li>
						      			<h4>โลตัส ปากช่อง</h4>
						      		...
						      		<li>
						      			<h4>บิ๊กซี พระราม 4</h4>
						      			<p>โทร. 02-258-4015</p>
						      		</li>
						      		<li>
						      			<h4>บิ๊กซี เพชรบุรี</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      		<li>
						      			<h4>The Seasons พหลโยธิน 1</h4>
						      			<p>โทร. 02-111-2048</p>
						      		</li>
						      		<li>
						      			<h4>สุพรีม สามเสน</h4>
						      		...
						      		<li>
						      			<h4>Lasalle Avenue</h4>
						      			<p>โทร. 02-181-1717</p>
						      		</li>
						      		<li>
						      			<h4>โลตัส รามอินทรา</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      		<li>
						      			<h4>มาร์เก็ตเพลส นางลิ้นจี่</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      		<li>
						      			<h4>ร้านตำมั่ว Express - Top สิงห์บุรี</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      	</ul>
						    </TabPanel>
						    <TabPanel>
						      	<ul>
						      		...
						      		<li>
						      			<h4>เซ็นทรัล พลาซ่า อุดรธานี</h4>
						      			<p>โทร. 061-359-5165</p>
						      		</li>
						      		<li>
						      			<h4>บิ๊กซี กาฬสินธุ์</h4>
						      			<p>โทร. 043-840-858</p>
						      		</li>
						      	</ul>
						    </TabPanel>
						    ...
						    <TabPanel>
						    	<ul>
						    		<li>
						      			<h4>พนมเปญ กัมพูชา</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      		<li>
						      			<h4>ย่างกุ้ง เมียนมาร์ (Downtown)</h4>
						      			<p>เร็วๆ นี้</p>
						      		</li>
						      		<li>
						      			<h4>เวียงจันทน์ 1</h4>
